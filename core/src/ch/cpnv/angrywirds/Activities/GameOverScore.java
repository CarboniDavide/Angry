...
import ch.cpnv.angrywirds.StatusConnection.GamePostConnection;
...
public class GameOverScore extends GameActivity implements InputProcessor{
    ...
    GamePostConnection gamePostConnection;
    ...
    public GameOverScore(GameScore gameScore){
        ...
        showBestScore = new ShowBestScore(Store.bestScore, gameScore);
        Store.write();
        //Send the new Result to the Server using gamePostConnectio
        gamePostConnection = new GamePostConnection(gameScore, null);
    }
    ...
    public boolean touchDown(int screenX, int screenY, int pointer, int button) {
        ...
        if (play.checkIfClicked(touch.x,touch.y))AngryWirds.gameActivityManager.rePlay(new Welcome());
